  ...
  const handleDownload = async () => {
    ...
    try {
      const canvas = await html2canvas(ticketElement, {
        ...
        windowWidth: ticketElement.scrollWidth, // Captures full width
        windowHeight: ticketElement.scrollHeight, // Captures full height
      });
  
      const link = document.createElement("a");
      link.href = canvas.toDataURL("image/png");
      link.download = "ticket.png"; // Filename
      link.click();
    } catch (error) {

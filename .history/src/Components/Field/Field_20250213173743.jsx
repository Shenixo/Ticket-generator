    ...
    <div className="field">
        ...
        <div>
          ...
          <div
            className={`error-message ${
              error[type === "text" ? "name" : "email"] ? "show" : ""
            }`}
          >
            <small role="alert">
              {error[type === "text" ? "name" : "email"]}
            </small>
          </div>
        </div>
      )}
      ...
      {field === "image-upload" && (
        <div className="image-upload-container">
          ...
          <div className={`error-message ${error.profile_upload ? "show" : ""}`}>
            <small className="upload-err" role="alert">{error.profile_upload}</small>
          </div>
        </div>
      )}
            ...
            {Object.entries(ticketType).map(([key, value], idx) => (
              ...
              >
                <h3 style={{ marginBottom: ".4rem" }}>
                  {typeof value.price > 0 "number" ? "$" : null}

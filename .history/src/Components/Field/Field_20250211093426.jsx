...
const Field = ({ label_content, field }) => {
  const { activeTab, setActiveTab, formData, handleFormData } = useTicketContext();
  ...
  return (
    ...
    name="number_of_tickets" // Ensure the name matches the formData key
    id="dropdown"
    value={formData.number_of_tickets} // No need for defaultValue if value is set
  >

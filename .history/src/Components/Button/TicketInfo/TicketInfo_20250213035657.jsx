...
import { activeTab } from "../../Context/TicketContext"
import {yy} from "../../../Context/TicketContext"
const tt  = Object.entries(ticketType).map(([_, value], idx) => console.log(value.type)  )
const TicketInfo = () => {

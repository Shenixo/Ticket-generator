...
const TicketContextProvider = ({ children }) => {
  ...
  const [formData, setFormData] = useState({
    ...
    name: "",
    email: "",
    profile_upload: "",  // Stores image preview URL
    special_request: ""
  });
  ...
  // Handle text input & dropdown selection
  ...
  // Handle image upload and store as preview
  ...
  const handleVerifyForm = (event) => {
    ...
    if (!toProceed) {
      ...
      if (!formData.profile_upload) {
        newErrors.profile_upload = "Upload an image";
      }
    }
